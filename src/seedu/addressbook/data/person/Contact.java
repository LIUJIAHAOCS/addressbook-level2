...
public class Contact {
    ...
    public Contact(String value, boolean isPrivate, String messageContactConstraints, String contactValidationRegex) throws IllegalValueException {
     ...
     */
    public static boolean isValidContact(String test, String contactValidationRegex) {
